class Blaze extends Foe
{
   ...
   var foeDescription = "Attacks with fire, smoke and sharp teeth.";
   var maxHP = 1700;
   var attack = 4;
   var defence = 4;
   var magicAttack = 6;
   ...
   var subGraphic = 2;
   var elementalResistance = ["fire",-0.5,"water",2,"ice",1.9,"thunder",1,"wind",1.8,"poison",1,"earth",1,"dark",1,"holy",1,"bomb",0];
   var statusResistance = ["poison",0.1,"stun",0,"syphon",0.1,"death",0,"berserk",1,"dispel",1,"doom",1,"attackDown",1,"defenceDown",1,"magicAttackDown",1,"magicDefenceDown",1,"accuracyDown",1,"evadeDown",1];
   function Blaze(a, b, c, d)
   {
      super(a,b,c,d);
   ...
   function makeMove()
   {
      ...
      if(this.spawnWait <= 0 and this.deadDragons == 2)
      {
         ...
         if(_loc2_ == 0)
         {
            this.parent.spawnFoe(RedClay,this.level + 1);
         }
         if(_loc2_ == 1)
         {
            this.parent.spawnFoe(DrillBot,this.level + 1);
         }
         if(_loc2_ == 2)
         {
            this.parent.spawnFoe(Eyeball,this.level + 1);
         }
         if(_loc2_ == 3)
         {
            this.parent.spawnFoe(FireBit,this.level + 1);
         }
      }
      this.spawnWait -= 1;
   }
